...
digraph {
  ...
  HEAD [shape=box, label="HEAD", fillcolor="#C94326", style=filled];
  mybranch [shape=box, label="mybranch", fillcolor="#F7A913", style=filled];
  master [shape=box, fillcolor="#1F908E", label="master",  style=filled];
...
digraph {
  ...
  mybranch -> G;
  master -> C;
  origin_master -> E [color="#E3E7E8"];
  
  A [label="A"];
  B [label="B"];
  C [label="C"];
  D [label="D", color="#E3E7E8"];
  E [label="E", color="#E3E7E8"];
  F [label="F"];
  G [label="G"];
  ...
  mybranch [shape=box, label="mybranch", fillcolor="#F7A913", style=filled];
  master [shape=box, fillcolor="#1F908E", label="master",  style=filled];
  origin_master [shape=box, label="origin/master",  fillcolor="#E3E7E8", color="#E3E7E8", style=filled ];
...
digraph {
  ...
  HEAD [shape=box, label="HEAD", fillcolor="#C94326", style=filled];
  master [shape=box,fillcolor="#1F908E", style=filled ];
...
digraph {
  rankdir=LR;
  node [shape=circle, width=0.2, colorscheme=oranges9];
  edge [arrowhead=normal];
  ...
  HEAD [shape=box, label="HEAD", fillcolor="#C94326", style=filled];
  master [shape=box,fillcolor="#1F908E", style=filled ];
  new_b  [shape=box,fillcolor="#F1D763", style=filled, label="the_new_branch"];
...
[Be very very very careful, it is a destructive process. All information regarding your previous commit is lost.]{.care}
...
digraph {
  ...
  HEAD [shape=box, label="HEAD", fillcolor="#C94326", style=filled];
  master [shape=box,fillcolor="#1F908E", style=filled ];
  new_b  [shape=box,fillcolor="#F1D763", style=filled, label="local_branch"];
...
[Only th change made to come from A to B are reversed]{.care}. Of course it might produce conflicts you have to solve.
